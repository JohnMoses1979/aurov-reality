...
const DEPARTMENT = 'HR';
const TITLE = 'HR Assign Tasks';
const workflowApi = departmentManagerWorkflowApi.hr;

export default function HrManagerAssignTasks() {
  ...
  const loadData = async () => {
    try {
      ...
      setMessage(error.message || 'Unable to load HR task data.');
    } finally {
      setLoading(false);
    }
  };
