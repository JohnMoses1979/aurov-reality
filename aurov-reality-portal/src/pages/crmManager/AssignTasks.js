...
const TITLE = 'CRM Assign Tasks';
const workflowApi = departmentManagerWorkflowApi.crm;

export default function CrmManagerAssignTasks() {
  ...
  const loadData = async () => {
    try {
      ...
      setMessage(error.message || 'Unable to load CRM task data.');
    } finally {
      setLoading(false);
    }
  };
