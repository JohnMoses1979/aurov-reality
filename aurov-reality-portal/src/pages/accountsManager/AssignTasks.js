...
const TITLE = 'Accounts Assign Tasks';
const workflowApi = departmentManagerWorkflowApi.accounts;

export default function AccountsManagerAssignTasks() {
  ...
  const loadData = async () => {
    try {
      ...
      setMessage(error.message || 'Unable to load accounts task data.');
    } finally {
      setLoading(false);
    }
  };
