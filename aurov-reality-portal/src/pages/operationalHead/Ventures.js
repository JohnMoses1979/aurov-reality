...
//               <Link to={`/operational-head/ventures/${venture.id}`} className="relative block h-56 overflow-hidden">
...
//                   <Link to={`/operational-head/ventures/${venture.id}`}><PrimaryButton variant="outline" className="w-full px-2"><FiEye /> View</PrimaryButton></Link>
...
//                   <Link to={`/operational-head/properties?ventureId=${venture.id}`}><PrimaryButton className="w-full px-2"><FiGrid /> Properties</PrimaryButton></Link>
//                 </div>
//               </div>
//             </article>
//           );
      ...
      <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
        {ventures.map((venture) => {
          ...
          return (
            ...
            >
              <Link
                to={`/operational-head/ventures/${venture.id}`}
              ...
              <div className="p-5">
                ...
                <div className="mt-5 grid grid-cols-3 gap-2">
                  <Link to={`/operational-head/ventures/${venture.id}`}>
                  ...
                  <Link to={`/operational-head/properties?ventureId=${venture.id}`}>
