...
//               <Link to={`/operational-head/properties/${property.id}`}><PrimaryButton variant="outline" className="mt-4 w-full">View Details</PrimaryButton></Link>
//             </div>
//           </article>
//         ))}
        ...
        {filtered.map((property) => (
          ...
          >
            ...
            <div className="p-5">
              ...
              <Link to={`/operational-head/properties/${property.id}`}>
